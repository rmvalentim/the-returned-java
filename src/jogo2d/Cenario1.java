...
public class Cenario1 extends Cenario {
    ...
    public Cenario1( Window window, double energ, long minutos, long segundos){
        janela = window;
    ...
    private void mudarCenario(){
        // Se o jogador colidir com o tile 7 ou 8
        // ele vai para o cenario 2
        if(tileCollision(7, jogador, cena) == true ||
                tileCollision(8, jogador, cena) == true){
            s.stop();
            new Cenario2(janela, jogador.energia, tempo.getMinute(), tempo.getSecond());
        }
    }
}
